...
export default function Home() {
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-blue-50 to-white ${styles.container}`}
    >
      {/* Encabezado */}
      ...
      <section className={`mt-16 ${styles.cardsContainer}`}>
        <div className={`${styles.card} flex flex-row items-start space-x-4`}>
          ...
          <Image src={idea} alt="idea" width={200} height={264} className="" />
        </div>
      ...
      <div className="flex items-center justify-center w-full mt-8">
        ...
        <span className="text-orange-500 mx-2 font-semibold text-lg">
          softwares
        </span>
        <hr className="border-t-2 border-orange-500 w-1/3" />
      </div>
